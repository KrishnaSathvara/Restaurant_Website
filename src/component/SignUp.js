  ...
  return (
    <div className="flex items-center bg-blue-300 justify-center h-screen">
      <div className="w-full max-w-xs">
        <h1 className="text-3xl font-bold mb-6 text-center">SIGN UP
        </h1>
        {!registered ? (
          <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div className="flex items-center justify-between">
              <button
                className="bg-pink-600 hover:bg-blue-700 w-72 rounded-md text-white font-bold py-2 px-4  focus:outline-none focus:shadow-outline"
                type="button"
